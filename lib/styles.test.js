...
<style>
  TEST
    ...
    test('should return a styles string for pug', () => {
      const mockDom = {
        attr() {
          return 'importFile';
        }
      ...
      Importer.resolveImport.mockReturnValue('TEST');
      const styles = EzwcStyles.parseStyles(mockDom, 'pug');
      expect(styles).toBe(`
style.
  TEST
      `);
...
<style>
  ...
  describe('generate style tag', () => {
    test('should generate a style tag for CSS', () => {
...
`
    ...
    test('should generate a style tag for Scss entered as sass', () => {
      const styleTag = EzwcStyles.generateStyleTag('sass');
      expect(styleTag).toBe(`
<style lang="scss">
</style>
`
    ...
    test('should generate a style tag for Scss entered as scss', () => {
      const styleTag = EzwcStyles.generateStyleTag('scss');
      expect(styleTag).toBe(`
<style lang="scss">
</style>
`
    ...
    test('should generate a style tag with import for CSS', () => {
      const styleTag = EzwcStyles.generateStyleTag(undefined, 'hello-world', true);
      expect(styleTag).toBe(`
<style src="./hello-world.ezwc.css">
</style>
`
      );
    });
    ...
    test('should generate a style tag with import for Scss entered as sass', () => {
      const styleTag = EzwcStyles.generateStyleTag('sass', 'hello-world', true);
      expect(styleTag).toBe(`
<style lang="scss" src="./hello-world.ezwc.scss">
</style>
`
      );
    });
    ...
    test('should generate a style tag with import for Scss entered as scss', () => {
      const styleTag = EzwcStyles.generateStyleTag('scss', 'hello-world', true);
      expect(styleTag).toBe(`
<style lang="scss" src="./hello-world.ezwc.scss">
</style>
`
