...
TEST
  ...
  describe('create render function', () => {
    test('should create the render function for html', () => {
      const createRenderFunction = EzwcTemplates.createRenderFunction('TEST', { shadowRoot: true });
    ...
    test('should create the render function for html with no-shadow', () => {
      const createRenderFunction = EzwcTemplates.createRenderFunction('TEST', { shadowRoot: false });
      expect(createRenderFunction).toBe(`render(data) {
          const template = \`TEST\`;
          const templateNode = new DOMParser().parseFromString(template, 'text/html').firstChild;
          this.innerHTML = '';
    ...
    test('should create the render function for lit', () => {
      const createRenderFunction = EzwcTemplates.createRenderFunction('TEST', { template: 'lit', shadowRoot: true });
      expect(createRenderFunction).toBe(`render(data) {
    ...
    test('should create the render function for lit-html', () => {
      const createRenderFunction = EzwcTemplates.createRenderFunction('TEST', { template: 'lit-html', shadowRoot: true });
      expect(createRenderFunction).toBe(`render(data) {
          const template = html\`TEST\`;
          render(template(this), this.shadowRoot);
        }`
    ...
    test('should create the render function for pug', () => {
      const createRenderFunction = EzwcTemplates.createRenderFunction('TEST', { template: 'pug', shadowRoot: true });
      expect(createRenderFunction).toBe(`render(data) {
    ...
    test('should create the render function for hbs', () => {
      const createRenderFunction = EzwcTemplates.createRenderFunction('TEST', { template: 'hbs', shadowRoot: true });
      expect(createRenderFunction).toBe(`render(data) {
          if (!this.compiledTemplate) {
    ...
    test('should create the render function for handlebars', () => {
      const createRenderFunction = EzwcTemplates.createRenderFunction('TEST', { template: 'handlebars', shadowRoot: true });
      expect(createRenderFunction).toBe(`render(data) {
          if (!this.compiledTemplate) {
            this.compiledTemplate = Handlebars.compile(\`TEST\`);
          }
    ...
    test('should create the render function for ejs', () => {
      const createRenderFunction = EzwcTemplates.createRenderFunction('TEST', { template: 'ejs', shadowRoot: true });
      expect(createRenderFunction).toBe(`render(data) {
          const template = \`TEST\`;
...
`
    ...
    test('should generate a template tag for pug', () => {
      const templateTag = EzwcTemplates.generateTemplateTag('pug');
      expect(templateTag).toBe(`
<template lang="pug">
</template>
`
...
`
    ...
    test('should generate a template tag with import for pug', () => {
      const templateTag = EzwcTemplates.generateTemplateTag('pug', 'hello-world', true);
      expect(templateTag).toBe(`
<template lang="pug" src="./hello-world.ezwc.pug">
</template>
`
      );
    });
